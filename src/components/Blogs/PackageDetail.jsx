...
const PackageDetail = () => {
  ...
  if (!location.state)
    return <div className="text-center py-20">No package data found</div>;
      ...
      <div className="max-w-6xl mx-auto bg-white rounded-[40px] shadow-2xl overflow-hidden border">
        <div className="relative h-[500px]">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent flex flex-col justify-end p-12">
            <div className="flex gap-2 mb-4">
              <span className="bg-primary text-white px-4 py-1 rounded-full text-xs font-black uppercase">
                {tourType}
              </span>
              <span className="bg-secondary text-white px-4 py-1 rounded-full text-xs font-black uppercase">
                {category}
              </span>
            </div>
            ...
            <div className="flex items-center gap-6 text-white/80 font-bold">
              <span className="flex items-center gap-2">
                <IoLocationOutline className="text-primary text-xl" /> {loc}
              </span>
              <span className="flex items-center gap-2">
        ...
        <div className="p-12 grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 space-y-10">
            <div>
              <h2 className="text-2xl font-black text-gray-900 uppercase tracking-tight mb-4 underline decoration-primary decoration-4 underline-offset-8">
                Description
              </h2>
