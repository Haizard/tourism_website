  ...
  return (
    <div className="h-screen w-screen fixed top-0 left-0 bg-black/50 z-50 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="w-[450px] bg-white rounded-3xl p-8 shadow-2xl relative">
        {/* Close Button */}
        <div
          className="absolute top-4 right-4 text-2xl cursor-pointer hover:text-primary transition"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="bg-gray-50 p-6 rounded-3xl border border-gray-100 space-y-4">
                <div className="flex items-center justify-between">
                  <label className="flex items-center gap-2 text-sm font-black text-gray-400 uppercase">
                ...
                <div className="border-t pt-4 flex items-center justify-between">
                  <p className="flex items-center gap-2 text-sm font-black text-gray-400 uppercase">
